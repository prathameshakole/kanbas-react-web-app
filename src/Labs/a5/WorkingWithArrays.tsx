...
function WorkingWithArrays() {
    ...
    const API = "https://kanbas-node-server-app-d1hp.onrender.com/a5/todos";
    ...
    return (
        <div>
            ...
            <a className="btn btn-danger" href={API}>
                Get Todos
            </a>
            <br />
            ...
            <ul>
                {todos.map((todo) => (
                    <li key={todo.id}>
                        ...
                        <button className="btn btn-danger ms-2 me-3" onClick={() => removeTodo(todo)} >
                            Remove
                        </button>
            ...
            <br />
            <br />
            <a className="btn btn-success" href={`${API}/${todo.id}/title/${todo.title}`} >
            ...
            <a className="btn btn-danger" href={`${API}?completed=true`}>
                Get Completed Todos
            </a>
            <br />
            ...
            <h3>Updating Todo Description and Completed State</h3>
            <input
                value={todo.id}
